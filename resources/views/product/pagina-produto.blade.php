...
<head>
    ...
    <link rel="apple-touch-icon" href="/img/light_mode_png.png">
    <link rel="shortcut icon" type="image/x-icon" href="/img/light_mode_png.png">
...
<body>
    <header>
        <iframe src="header" frameborder="0" width="100%" height="80"></iframe>
    </header>
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="/img/banner1.jpg" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
